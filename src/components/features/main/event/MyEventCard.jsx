...
const MyEventCard = ({name, title, event = 'BirthDay', view = 'detailed', timeLeft}) => {
  ...
  return (
    ...
    <div className='flex flex-col gap-8 justify-center items-center'>
        ...
        {/* <div className='w-full lg:w-[21.875rem] h-auto flex flex-col gap-6 bg-gradient-to-b from-slate-300 to-slate-400 p-4 rounded-lg text-slate-800'>
            ...
            <p className='text-sm'> What are you planning? 
                Remember to add more wishes to your list so that your kindred have more options. 
                Set up your birthday campaign so that you can start sharing your page.
            </p>
            <Button 
            variant='event'
            to={''}
